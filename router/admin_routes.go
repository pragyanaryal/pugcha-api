...
func SetupAdminRoutes(r *mux.Router, host string) {
	...
	front.HandleFunc("/{rest:.*}", adminHandler(proxy, remote))
...
func adminHandler(p *httputil.ReverseProxy, url2 *url.URL) func(http.ResponseWriter, *http.Request) {
